...
**生成时间**：2026-02-24T09:42:30.304853  
...
```
openapi: 3.0.3
info: { title: ERP Cell API, version: 1.0.0 }
...
components:
  schemas:
    Error: { type: object, properties: { code: {}, message: {}, requestId: {} } }
...
2. 运行 `./run.sh verify erp` 或 `./scripts/verify_delivery.sh erp` 通过后置为 production_ready。
