...
**生成时间**：2026-02-24T09:42:30.320221  
...
```
openapi: 3.0.3
info: { title: MES Cell API, version: 1.0.0 }
servers: [{ url: /api/v1/mes }]
paths:
  /work-orders:
    get:
...
2. 运行 `./run.sh verify mes` 或 `./scripts/verify_delivery.sh mes` 通过后置为 production_ready。
