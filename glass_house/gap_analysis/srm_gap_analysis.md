...
**生成时间**：2026-02-24T09:42:30.330196  
...
```
openapi: 3.0.3
info: { title: SRM Cell API, version: 1.0.0 }
servers: [{ url: /api/v1/srm }]
paths:
  /suppliers:
    get:
...
2. 运行 `./run.sh verify srm` 或 `./scripts/verify_delivery.sh srm` 通过后置为 production_ready。
