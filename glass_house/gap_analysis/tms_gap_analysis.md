...
**生成时间**：2026-02-24T09:42:30.333971  
...
```
openapi: 3.0.3
info: { title: TMS Cell API, version: 1.0.0 }
servers: [{ url: /api/v1/tms }]
paths:
  /shipments:
    get:
...
2. 运行 `./run.sh verify tms` 或 `./scripts/verify_delivery.sh tms` 通过后置为 production_ready。
