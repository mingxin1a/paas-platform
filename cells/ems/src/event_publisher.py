"""
EMS 细胞事件发布：通过 HTTP 向平台事件总线发布领域事件，无 platform_core 依赖。
环境变量：EVENT_BUS_URL 或 GATEWAY_URL；可选 EVENT_BUS_TOKEN / GATEWAY_TOKEN。
"""
...
logger = logging.getLogger("ems.events")
